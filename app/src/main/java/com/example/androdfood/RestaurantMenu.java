...
import com.example.androdfood.adapter.MenuListAdapter;
...
public class RestaurantMenu extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(RestaurantMenu.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }
                restaurantModel.setMenus(itemsInCartList);
                Intent i = new Intent(RestaurantMenu.this, PlaceYourOrderActivity.class);
